%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PLOT_NSIGMA_ELLIPSOID plots 2-d and 3-d Gaussian distributions
% Originally from: https://www.mathworks.com/matlabcentral/fileexchange/7964-plot-gaussian-ellipsoids
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function h = plot_nsigma_ellipsoid(m, C, sdwidth, npts, axh)
    ...
    arguments
        m double
        C double {issymmetric(C)}
        sdwidth double = 3
        npts double = []
        axh {mustBeA(axh, 'matlab.graphics.axis.Axes')} = gca
    end
    ...
    switch numel(m)
        ...
        otherwise, error('State must be 2-d or 3-d');
    end
    if nargout==0,
        clear h;
    end
