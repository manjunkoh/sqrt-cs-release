...
The full covariance approach is unable to solve the problem, as MOSEK returns status \texttt{UNKNOWN}. This indicates numerical issues, where the returned solution may or may not be close to a feasible and optimal solution \cite{mosekapsMOSEKOptimizationToolbox2025}. 
