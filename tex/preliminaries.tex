...
The state covariance matrix is defined as $P_k := \E{(x_k - \E{x_k})(x_k - \E{x_k})^\top}$. 
...
\begin{lemma}[Ch. 3.8 of \cite{ipsenNumericalMatrixAnalysis2009}]\label{lemma:existence_and_uniqueness_of_economy_size_qr_decomposition}
	...
	\end{itemize}
\end{lemma}
From here on, ``QR decomposition'' will refer to the economy-size QR decomposition with positive diagonal entries.
