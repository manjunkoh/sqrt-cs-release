...
$\cov{\cdot}$ denotes the covariance matrix of a random variable.
...
\begin{equation} \label{eq:objective_function}
	...
	\mathcal{Q}_{\|W_{k}^x x_k\|_2}(p_J) +
	\mathcal{Q}_{\|W_{k}^u u_k\|_2}(p_J)
	\end{cases}
\end{equation}
...
Let $P_k := \cov{x_k}$.
We make the following assumption, reasonable in practical applications and also made in \cite{liuOptimalCovarianceSteering2025}:
