...
\begin{remark}
	\normalfont Another method of proof is to show that the KKT conditions of (A) and (B) are equivalent. Readers are referred to Proposition 1 of \cite{fatkhullinGlobalSolutionsNonConvex2025}. The assumptions used in the proposition, 1. weak convexity of the objective and constraints and 2. differentiability of the coordinate transformation, are satisfied by the problem statement in \cref{eq:nonconvex_problem_statement}.
\end{remark}
